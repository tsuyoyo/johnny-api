...
describe("verifyToken", () => {
    ...
    describe("when verifyIdToken throwns error", () => {
        ...
        const mockedVerifyIdToken = jest.fn()
            .mockImplementation((_token: string) =>
        ...
        it("should NOT call next", function() {
            ...
            return expect(verifyToken(mockedVerifyIdToken, jest.fn())("token"))
                .rejects
    ...
    describe("when verifyIdToken success", () => {
        ...
        describe("when getUser throws exception", () => {
            ...
            it("should NOT call next", function() {
                return expect(verifyToken(mockedVerifyIdToken, mockedGetUser)("token"))
                    .rejects
                    .toThrow(expectedError);
            });
        })
        ...
        describe("when getUser return UserRecord", () => {
            ...
            const mockedGetUser = jest.fn()
                .mockImplementation((_uuid: string) =>
            ...
            it("should return FirebaseUser", function() {
                return expect(verifyToken(mockedVerifyIdToken, mockedGetUser)("token"))
                    .resolves
                    .toMatchObject(expectedFirebaseUser);
            });
        })
    })
})